...
describe("plugin", function()
    ...
    describe("project root", function()
        ...
        it("should find proper root if present", function()
            local actual = sut._find_pom_directory(path:new(vim.loop.cwd(), "fixture/src/main/java/com/example"))
            assert.are_same(vim.loop.cwd() .. "/fixture", actual)
        end)
        it("should find proper root", function()
            local actual = sut._find_pom_directory(path:new(vim.loop.cwd(), "fixture"))
            assert.are_same(vim.loop.cwd() .. "/fixture", actual)
        end)
        it("should return nil if no root can be found", function()
            local actual = sut._find_pom_directory(path:new(vim.loop.cwd()))
